...
class AulaWordpress implements IAulaWordpress {
    ...
    private $custom_post_activity_name   = "aula-activity";
    ...
    public function initialize_plugin()
    {
        ...
        $params['show_ui']               = $this->debug;
        $params['show_tagcloud']         = $this->debug;
        ...
        $this->registerAulaItem($public_posts_enabled, $this->debug, $public_posts_slug,$this->custom_post_course_name,"Aula Course","An Aula Course, generated by Aula.");
        // create the topic custom post type
        $this->registerAulaItem($public_posts_enabled, $this->debug, $public_posts_slug,$this->custom_post_topic_name,"Aula Topic","An Aula Topic, generated by Aula.");
        // create the activity custom post type
        $this->registerAulaItem($public_posts_enabled, $this->debug, $public_posts_slug,$this->custom_post_activity_name,"Aula Activity","An Aula Activity, generated by Aula.");
    }

    /**
     * @param $public_posts_enabled
     * @param $debug
     * @param $public_posts_slug
     * @return array
     */
    public function registerAulaItem($public_posts_enabled, $debug, $public_posts_slug, $custom_post_name, $title, $description)
    {
        $params = array();
        $params['label'] = __($title, 'aula');
        $params['public'] = $public_posts_enabled;
        $params['show_ui'] = $debug;
        $params['show_in_nav_menus'] = $debug;
        $params['supports'] = array('title', 'editor', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'thumbnail', 'author', 'page-attributes');
        $params['description'] = __($description, 'aula');
        $params['hierarchical'] = true;
        ...
        register_post_type($custom_post_name, $params);
        register_taxonomy_for_object_type('category', $custom_post_name);
        register_taxonomy_for_object_type('post_tag', $custom_post_name);
        return $params;
    }
