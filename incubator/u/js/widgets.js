...
__twttrlr(function (using, provide, loadrunner, define) {
    provide("util/util", function (a) {
        ...
        a({aug: b, compact: c, containsElement: j, filter: e, map: f, trim: g, indexOf: d, isNative: i, isObject: k, toType: h})
    });
    ...
    provide("tfw/util/tracking", function (a) {
        using("dom/cookie", "dom/sandbox", "util/donottrack", "tfw/util/guest_cookie", "tfw/util/env", "util/util", "$xd/json2.js", function (b, c, d, e, f, g, h) {
            function u() {
                ...
                s = document.getElementById("rufous-sandbox"), s ? (r = s.contentWindow.document, q = r.body) : c(a, {id: "rufous-sandbox"}, {display: "none"})
            }
            ...
            function w(a, c, h, i) {
                var k = j[c], l, m, n = e.guest_id_cookie;
                if (!k)return;
            ...
            function y(a, b, c) {
                ...
                f = g.aug({}, b, {event_namespace: a}), c ? (j += E({l: J(f)}), H(j)) : (d = m.firstChild, d.value = +d.value || +f.dnt, h = J(f), e = r.createElement("input"), e.type = "hidden", e.name = "l", e.value = h, m.appendChild(e))
            }
            ...
            function C(a) {
                var b = {client: "tfw"}, c, d;
                return c = g.aug(b, a || {}), c
            }

            function D(a, b, c) {
                var e = {_category_: "tfw_client_event"}, f, h, i;
            ...
            function F() {
                var a = r.createElement("form"), b = r.createElement("input");
            ...
            var i = "twttr_", j = {tweetbutton: "//p.twitter.com/t.gif", followbutton: "//p.twitter.com/f.gif", tweetembed: "//p.twitter.com/e.gif"}, k = ["hask", "li", "logged_in", "pid", "user_id", e.guest_id_cookie, i + "hask", i + "li", i + e.guest_id_cookie], l = 0, m, n, o = [], p, q, r, s, t = 1;
            e.forceNewCookie(), a({enqueue: z, flush: A, initPostLogging: u, addPixel: v, addLegacyPixel: w, addVar: x})
        })
    });
    ...
    provide("tfw/widget/timeline", function (a) {
        using("tfw/widget/syndicatedbase", "anim/transition", "tfw/widget/intent", "tfw/util/data", "tfw/util/tracking", "tfw/util/params", "util/css", "util/datetime", "util/env", "util/iframe", "util/insert", "util/throttle", "util/twitter", "util/querystring", "util/util", "dom/delegate", "dom/classname", "dom/get", function (b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            ...
            var t = "1.0", u = {CLIENT_SIDE_USER: 0, CLIENT_SIDE_APP: 2}, v = "timeline", w = "new-tweets-bar", x = "timeline-header", y = "timeline-footer", z = "stream", A = "h-feed", B = "tweet", C = "expanded", D = "detail-expander", E = "expand", F = "permalink", G = "tweet-box-button", H = "twitter-follow-button", I = "no-more-pane", J = "pending-scroll-in", K = "pending-new-tweet", L = "show-new-tweet", M = "show-tweet-box";
            N.prototype = new b, p.aug(N.prototype, {renderedClassNames: "twitter-timeline twitter-timeline-rendered", dimensions: {DEFAULT_HEIGHT: "600", DEFAULT_WIDTH: "520", NARROW_WIDTH: "320", MIN_WIDTH: "180", MIN_HEIGHT: "200", WIDE_MEDIA_PADDING: 81, NARROW_MEDIA_PADDING: 16}, create: function (a) {
                ...
                function k() {
                    f.initPostLogging(), e.timeline({id: c.widgetId, screenName: c.widgetScreenName, userId: c.widgetUserId, withReplies: c.widgetShowReplies, dnt: c.dnt, lang: c.lang, success: function (a) {
                ...
                for (; d = b[i]; i++)e = s.one(F, d, "A"), f = n.status(e.href), g = d.getAttribute("data-tweet-id"), f === g ? c[f] = {item_type: h.TWEET} : c[f] = {item_type: h.RETWEET, target_type: h.TWEET, target_id: g};
                return c
                ...
                this.requestTweets(c, !1, function (b) {
                    var d = s.one(I, a.element, "P"), e = b.childNodes[0];
                ...
                var b = this, d = s.one(z, this.element, "DIV"), e = s.one(A, d, "OL"), f = e.offsetHeight, g;
                ...
                var b = this, c = s.one(w, this.element, "DIV");
                ...
                var c = s.one("nsfw", a, "DIV"), d, e, f = 0, g, h, i, k;
                if (!c)return;
    ...
    provide("tfw/widget/embed", function (a) {
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "tfw/util/params", "dom/classname", "dom/get", "util/util", "util/throttle", "util/twitter", "tfw/util/data", "tfw/util/tracking", function (b, c, d, e, f, g, h, i, j, k) {
            function p(a, b, c) {
                var d = f.one("subject", a, "BLOCKQUOTE"), e = f.one("reply", a, "BLOCKQUOTE"), g = d && d.getAttribute("data-tweet-id"), h = e && e.getAttribute("data-tweet-id"), i = {}, j = {};
                if (!g)return;
                i[g] = {item_type: 0}, k.enqueue({page: "tweet", section: "subject", component: "tweet", action: "results"}, {client_version: l, widget_origin: document.location.href, message: b, item_ids: [g], item_details: i}, !0, c);
                if (!h)return;
                j[h] = {item_type: 0}, k.enqueue({page: "tweet", section: "conversation", component: "tweet", action: "results"}, {client_version: l, widget_origin: document.location.href, message: b, item_ids: [h], item_details: j, associations: {4: {association_id: g, association_type: 4}}}, !0, c)
            }

            function q(a, b, c) {
                var d = {};
                if (!a)return;
                d[a] = {item_type: 0}, k.enqueue({page: "tweet", section: "subject", component: "rawembedcode", action: "no_results"}, {client_version: l, widget_origin: document.location.href, message: b, item_ids: [a], item_details: d}, !0, c)
            }

            function r(a, b, c, d, e) {
                n[a] = n[a] || [], n[a].push({s: c, f: d, r: e, lang: b})
            }
            ...
            function s(a) {
                ...
                if ((b.align || this.attr("align")) == "left" || ~g.indexOf(this.classAttr, "tw-align-left"))this.align = "left"; else if ((b.align || this.attr("align")) == "right" || ~g.indexOf(this.classAttr, "tw-align-right"))this.align = "right"; else if ((b.align || this.attr("align")) == "center" || ~g.indexOf(this.classAttr, "tw-align-center"))this.align = "center", this.containerWidth > this.dimensions.MIN_WIDTH * (1 / .7) && this.width > this.containerWidth * .7 && (this.width = this.containerWidth * .7);
            ...
            var l = "2.0", m = "tweetembed", n = {}, o = {};
            s.prototype = new c, g.aug(s.prototype, {renderedClassNames: "twitter-tweet twitter-tweet-rendered", dimensions: {DEFAULT_HEIGHT: "0", DEFAULT_WIDTH: "500", NARROW_WIDTH: "350", MIN_WIDTH: "220", MIN_HEIGHT: "0", WIDE_MEDIA_PADDING: 32, NARROW_MEDIA_PADDING: 32}, create: function (a) {
                ...
                var b = f.all("twitter-follow-button", a, "A"), c, d = 0;
                ...
                var b = this, c = {related: this.related, partner: this.partner, tw_p: m};
                ...
                var a = n, b = [], c = 0, d, e;
                n = {};
                if (a.keys)b = a.keys(); else for (d in a)a.hasOwnProperty(d) && b.push(d);
                if (!b.length)return;
                k.initPostLogging(), e = a[b[0]][0].lang, j.tweets({ids: b.sort(), lang: e, complete: function (b) {
                    var c, d, e, f, g, h, i = [];
    ...
    provide("tfw/widget/tweetbutton", function (a) {
        using("tfw/widget/tweetbase", "util/util", "util/querystring", "util/uri", "dom/textsize", function (b, c, d, e, f) {
            var g = document.title, h = encodeURI(location.href), i = ["vertical", "horizontal", "none"], j = function (a) {
                ...
                if (d.type == "hashtag" || ~c.indexOf(this.classAttr, "twitter-hashtag-button"))this.type = "hashtag"; else if (d.type == "mention" || ~c.indexOf(this.classAttr, "twitter-mention-button"))this.type = "mention";
            ...
            j.prototype = new b, c.aug(j.prototype, {parameters: function () {
                ...
                var a = {ver: 8, cnt: 14, btn: 24, xlcnt: 18, xlbtn: 38}, b = this.count == "vertical", d = this.type == "hashtag" ? "Tweet %{hashtag}" : this.type == "mention" ? "Tweet to %{name}" : "Tweet", e = this._(d, {name: "@" + this.screen_name, hashtag: "#" + this.button_hashtag}), g = this._("K"), h = this._("100K+"), i = (b ? "8888" : "88888") + g, j = 0, k = 0, l = 0, m = 0, n = this.styles.base, o = n;
